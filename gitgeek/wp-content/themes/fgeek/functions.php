...
function fgeek_load_scripts() {
	...
	wp_enqueue_script( 'fgeek-js', get_template_directory_uri() . '/js/utilities.js',
		array( 'jquery', 'viewportchecker' ) );
		
	$data = array(
		'loading_effect' => ( get_theme_mod('fgeek_animations_display', 1) == 1 ),
	);
	wp_localize_script('fgeek-js', 'fgeek_options', $data);
	...
	<ul class="bxslider">
		<?php
			...
			for ( $i = 1; $i <= 3; ++$i ) {
					...
					$defaultSlideContent = __( '<h2>This is Default Slide Title</h2><p>You can completely customize Slide Background Image, Title, Text, Link URL and Text.</p><a class="btn" title="Read more" href="#">Read more</a>', 'fgeek' );
				...
				?>
					<li>
			  			<img src="<?php echo esc_url( $slideImage ); ?>" class="slider-img" alt="<?php echo esc_attr( sprintf( esc_html__( 'image %s', 'fgeek' ), $i )  ); ?>" />
			  			<div class="caption">						
...
function fgeek_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting(
		...
		array(
		    'default'           => __( '<h2>This is Default Slide Title</h2><p>You can completely customize Slide Background Image, Title, Text, Link URL and Text.</p><a class="btn" title="Read more" href="#">Read more</a>', 'fgeek' ),
	 ...
	 */
	$wp_customize->add_section(
		'fgeek_animations_display',
		array(
			'title'       => __( 'Animations', 'fgeek' ),
			'capability'  => 'edit_theme_options',
		)
	);
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize,
						'fgeek_animations_display',
							array(
								'label'          => __( 'Enable Animations', 'fgeek' ),
								'section'        => 'fgeek_animations_display',
								'settings'       => 'fgeek_animations_display',
								'type'           => 'checkbox',
							)
						)
	);
